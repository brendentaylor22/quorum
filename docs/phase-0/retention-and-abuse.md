...
The "10 active rooms per source per 24 hours" cap is enforced as ten *created* rooms — stricter than the wording, and much simpler, since a source that creates ten rooms and expires them still waits.
