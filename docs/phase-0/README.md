...
| TMDB registration and accepted-use review | [tmdb-use-review.md](tmdb-use-review.md) | Complete |
...
Phase 0 is `READY`. Product, architecture, privacy, abuse, provider-use, and threat contracts are fixed. Phase 1 may begin using synthetic fixtures. Before TMDB-backed Phase 3 deployment, implementation must pass credential-handling, attribution, cache-age, and egress controls recorded in [tmdb-use-review.md](tmdb-use-review.md) and [threat-model.md](threat-model.md).
